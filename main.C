...
int main(int argc, char **argv)
{
    ...
    psi[0] = vecDouble{0,1,0,0,0,0,0,0};
    
    psi[1] = vecDouble{1/std::sqrt(2),0,0,0,0,0,0,1/std::sqrt(2)};
    
    psi[2] = vecDouble{1/std::sqrt(8),1/std::sqrt(8),1/std::sqrt(8),
		       1/std::sqrt(8),1/std::sqrt(8),1/std::sqrt(8),
		       1/std::sqrt(8),1/std::sqrt(8)};
